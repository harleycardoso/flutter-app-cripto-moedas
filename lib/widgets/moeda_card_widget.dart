...
class MoedaCardWidget extends StatefulWidget {
  Moeda moeda;
  MoedaCardWidget({super.key,required this.moeda});

  @override
  State<MoedaCardWidget> createState() => _MoedaCardWidgetState();
}

class _MoedaCardWidgetState extends State<MoedaCardWidget> {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: InkWell(
        ...
        child: Row(
          children: [
            Image.asset(widget.moeda.icone,
            height: 40,
            ),
            ...
            PopupMenuButton(
              ...
              itemBuilder: (context) => [
                PopupMenuItem(
                  child: ListTile(
                    title: Text('Remove das Favoritas '),
                    onTap: (){
